...
def render():
    ...
    df_neg = con.execute("""
        SELECT COUNT(*) as total FROM fact_vaga WHERE negada = true
    """).df()
    ...
    if df.empty:
        st.info("Nenhuma candidatura registrada ainda. Comece se inscrevendo nas vagas!")
        return
    ...
    col2.metric("Chegaram em entrevista", int(conv["entrevistas"]))
    ...
    fig.update_layout(height=350, margin=dict(l=0,r=0,t=40,b=0),
        xaxis_title="", yaxis_title="Vagas", showlegend=False,
