...
pages = {
    ...
    "Construtor de Currículo": curriculo_builder.render,
    "Prática de Entrevista": pratica_entrevista.render,
    "Carta de Apresentação": carta_apresentacao.render,
    "Interview Buddy": interview_buddy.render,
    "Auto Apply": auto_apply.render,
