...
from dashboard.data_loaders import (
    carregar_vagas, carregar_empresas, carregar_logs,
    carregar_perfil_empresa, calcular_scores_vagas,
)
from dashboard.charts import (
    extrair_stacks_flat, grafico_stacks,
)
from dashboard.ui_components import (
    get_favicon, render_stacks, render_score_breakdown,
    render_diario, render_preparacao_entrevista, render_remuneracao,
